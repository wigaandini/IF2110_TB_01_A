...
int main() {
    ...
    AddressBalasan balasan1 = newBalasan(1, word1, 2, waktu);
    AddressBalasan balasan2 = newBalasan(2, word2, 3, waktu);

    // Contoh penggunaan fungsi insertBalasan
    Word word3 = {"First Balasan", 13};
    root = insertBalasan(root, word3, 1, 4, waktu);
    ...
    if (foundBalasan != NULL) {
        ...
        displayUnitBalasan(foundBalasan, &lsu, true);
    } else {
